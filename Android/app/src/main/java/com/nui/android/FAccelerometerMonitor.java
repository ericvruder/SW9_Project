 ...
 */
public class FAccelerometerMonitor extends SensorMonitor {
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if(event.sensor.getType() == Sensor.TYPE_ACCELEROMETER){
            ...
            if(tilt){
                ...
                MobileGesture data = new MobileGesture(Bboard.GetSelectedShape(), "Throw");
                server.SendData(data);
            }
        }
    }
    ...
    public MobileGesture IsTilt(float accelX, float accelY, float accelZ) {
        ...
        if(t>3.0f){
            return new MobileGesture(Bboard.GetSelectedShape(), "Tilt", "Push");
        }

        else if(t< -3.0f){
            return new MobileGesture(Bboard.GetSelectedShape(), "Tilt", "Pull");
        }
    ...
    public FAccelerometerMonitor(IServer server, Context context){
